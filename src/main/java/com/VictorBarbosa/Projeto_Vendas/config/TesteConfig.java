...
public class TesteConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Pedido p1 = new Pedido(null, Instant.parse("2022-05-17T23:23:30Z"), u1);//no Brasil é 3 horas atrasado do que no formato UTC
		Pedido p2 = new Pedido(null, Instant.parse("2022-05-18T12:23:30Z"), u2);
		Pedido p3 = new Pedido(null, Instant.parse("2022-05-19T14:53:30Z"), u1);
